...
public:
    Response();
    ~Response();
    Response(bool is_autoindex, std::string version,std::string path,std::string root, std::map<int, std::string> error_page_map ,int status_code,std::pair<bool, std::string> is_directory_file,std::map<std::string,std::string>body_form_data,std::string method);
